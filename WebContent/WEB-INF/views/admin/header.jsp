...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="${adminPath}/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  ...
  -->
  <link rel="stylesheet" href="${adminPath}/dist/css/skins/skin-blue.min.css">
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="${adminPath}/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="${adminPath}/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
