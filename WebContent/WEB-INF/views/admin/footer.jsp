...
<footer class="main-footer">
	<!-- To the right -->
	<div class="pull-right hidden-xs">BibliotecaFIT</div>
	<!-- Default to the left -->
	<strong>Copyright &copy; 2017 <a href="#">Gustavo e
			Leonardo</a>.
...
<script>
	$(document).ready(function() {
		...
		$seuCampoCpf3.mask('000.000.000-00', {
			reverse : true
		});
		var $seuCampoTel3 = $("#inputTelefone3");
		$seuCampoTel3.mask('00 00000-0000', {
			reverse : true
		});
