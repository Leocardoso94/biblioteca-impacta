...
<!-- iCheck -->
<link rel="stylesheet"
	href="${adminPath}/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="${adminPath}/index2.html"><b>Biblioteca</b>FIT</a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			<p class="login-box-msg">Entre para iniciar sua sessão</p>
			<p class="login-box-msg" style="color: red;">${erro}</p>
...
<!-- jQuery 2.2.3 -->
<script src="${adminPath}/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="${adminPath}/bootstrap/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="${adminPath}/plugins/iCheck/icheck.min.js"></script>
<script>
	$(function() {
		$('input').iCheck({
